...
interface FormikDatePickerProps<T extends dayjs.Dayjs>
  extends MakeOptional<DatePickerProps<T>, "value" | "onChange"> {
  name: string;
  label: string;
}

const FormikDatePicker = <T extends dayjs.Dayjs>({
  name,
  label,
  ...rest

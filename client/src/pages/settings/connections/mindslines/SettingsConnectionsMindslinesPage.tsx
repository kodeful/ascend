...
import ImportsMindslinesDataGrid from "./ImportsMindslinesDataGrid";

const SettingsConnectionsMindslinesPage = () => {
...
export default SettingsConnectionsMindslinesPage;

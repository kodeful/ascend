...
import { Import, ImportAssessment } from '../import/import.model';
import { Organisation } from '../organisation.model';

export class ImportDataThreeEyeView extends Document {
  @Expose()
  @IsMongoId()
...
export const ImportDataThreeEyeViewModel = getModelForClass(
  ImportDataThreeEyeView,
  {
    schemaOptions: {},
  },
);
Container.set(ImportDataThreeEyeView.name, ImportDataThreeEyeViewModel);
